"""Strategy Librarian service settings."""
...
class Settings(BaseSettings):
    """Configuration loaded from STRATEGY_LIBRARIAN_* env vars."""

    model_config = SettingsConfigDict(
        env_prefix="STRATEGY_LIBRARIAN_",
        env_file=".env",
        env_file_encoding="utf-8",
        extra="ignore",
    )

    service_name: str = "strategy-librarian"
